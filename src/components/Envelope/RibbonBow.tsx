    ...
    <AnimatePresence>
      {!isUntying && (
        ...
        >
          ...
          <div className="absolute w-full h-11 sm:h-12 flex items-center pointer-events-auto cursor-pointer">
          ...
          <div className="relative pointer-events-auto cursor-pointer flex items-center justify-center">
            ...
            <div className="absolute top-4 -left-5 w-4 h-10 sm:h-12 bg-gradient-to-b from-[#BA8C3E] to-[#875E20] transform -rotate-25 shadow-sm rounded-b-sm border-r border-[#FFDE94]/40" />

            {/* Ribbon Tail Drape Right */}
            <div className="absolute top-4 -right-5 w-4 h-10 sm:h-12 bg-gradient-to-b from-[#BA8C3E] to-[#875E20] transform rotate-25 shadow-sm rounded-b-sm border-l border-[#FFDE94]/40" />

            {/* Central Knot */}
            <div className="relative z-10 w-7 h-8 sm:w-8 sm:h-9 rounded-md bg-gradient-to-b from-[#FFE5A3] via-[#BA8C3E] to-[#785117] shadow-[0_2px_8px_rgba(40,25,10,0.35)] border border-[#FFE7A8]/60 flex items-center justify-center">
